import { FormControl, InputLabel, Select, Chip, MenuItem, SelectChangeEvent, Checkbox, ListItemText } from '@mui/material'
import CancelIcon from '@mui/icons-material/Cancel';
import React, { useMemo } from 'react';

export interface ISelectChipsComponentProps {
    label: string,
    elements: string[],
...
export default function SelectChipsComponent(props: ISelectChipsComponentProps) {
